...
class GestionExport(models.TransientModel):
    ...
    ], string="Tipo de reporte", default='attendance', required=True)
    ...
    def get_attendance_lines(self):
        ...
        # Se incluyen registros de asistencia en cualquier estado (borrador y confirmado)
        domain = []
    ...
    def get_today_date(self):
        """Retorna la fecha de hoy en el formato DD/MM/YYYY ajustada a la zona horaria del usuario."""
    ...
    def action_export(self):
        self.ensure_one()
        if self.export_type == 'attendance':
            ...
            # Generación del reporte en formato Excel (.xlsx)
                ...
                return self._export_attendance_xlsx()
